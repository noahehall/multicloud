...
- [subnets: pub & priv scenario](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Scenario2.html)
- [testing networking performance PDF](https://d1.awsstatic.com/events/reinvent/2019/REPEAT_3_How_to_test_network_performance_on_AWS_NET404-R3.pdf)
...
- [traffic mirror: targets](https://docs.aws.amazon.com/vpc/latest/mirroring/traffic-mirroring-targets.html)
- [troubleshoot network throughput between ec2 instances over an IGW](https://aws.amazon.com/premiumsupport/knowledge-center/network-issue-vpc-onprem-ig/)
