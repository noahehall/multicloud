...
- files stored in buckets: 5tb per object limit
...
- consistency
  - strong read-after-write: for PUT and DELETE actions
  - strongly: for S3 Select, S3 access control lists, S3 object tags, and object metadata
